    ...
    var e = {
        ...
        return _inherits(B, Component), _createClass(B, [{
            ...
            key: "setDate", value: function (t, e) {
                ...
                if ("string" == typeof t && (t = this.options.calendarType === "jalali" ? this._parseDate(t) : new Date(Date.parse(t))), B._isDate(t)) {
            ...
            key: "_renderDateDisplay", value: function () {
                var t = B._isDate(this.date) ? this.date : new Date(), e = this.options.i18n, i, n, s, year;
                if (this.options.calendarType === "jalali") {
                    var jd = jalaali.toJalaali(t.getFullYear(), t.getMonth() + 1, t.getDate());
                    i = e.weekdaysShort[t.getDay()];
                    n = e.monthsShort[jd.jm - 1];
                    s = jd.jd;
                    year = jd.jy
                } else {
                    i = e.weekdaysShort[t.getDay()];
                ...
                this.yearTextEl.innerHTML = year;
            ...
            key: "gotoDate", value: function (t) {
                ...
                if (B._isDate(t)) {
                    if (this.options.calendarType === "jalali") {
                        var jd = jalaali.toJalaali(t.getFullYear(), t.getMonth() + 1, t.getDate());
                        if (this.calendars) {
                            this.calendars[0] = {month: jd.jm - 1, year: jd.jy}
                        } else {
                            this.calendars = [{month: jd.jm - 1, year: jd.jy}]
                        }
                    } else {
                        if (this.calendars) {
                            var i = new Date(this.calendars[0].year, this.calendars[0].month, 1),
                                ...
                                s = t.getTime();
                            n.setMonth(n.getMonth() + 1), n.setDate(n.getDate() - 1);
            ...
            key: "render", value: function (t, e, i) {
                var n = this.options, ctp = n.calendarType, s = new Date(), o = B._getDaysInMonth(t, e, ctp), r = [],
                    l = [];
                B._setToStartOfDay(s);
                var a, pMonth, pYear, nextMonth, nextYear, pMonthDays;
                if (n.calendarType === "jalali") {
                    var firstDayGregorian = jalaali.toGregorian(t, e + 1, 1);
                    a = new Date(firstDayGregorian.gy, firstDayGregorian.gm - 1, firstDayGregorian.gd).getDay();
                    ...
                    pMonthDays = B._getDaysInMonth(pYear, pMonth, ctp)
                } else {
                    a = new Date(t, e, 1).getDay();
                    0 < n.firstDay && (a -= n.firstDay) < 0 && (a += 7);
                    pMonth = 0 === e ? 11 : e - 1;
                    nextMonth = 11 === e ? 0 : e + 1;
                    pYear = 0 === e ? t - 1 : t;
                    nextYear = 11 === e ? t + 1 : t;
                    pMonthDays = B._getDaysInMonth(pYear, pMonth, ctp)
                }
                ...
                var daysInCalendar = weeks * 7;
                var m = !1, g = 0, _ = 0;
                for (g = 0; g < daysInCalendar; g++) {
                    var dayNumber = g - a + 1;
                    var jm, jy, jd;
                    var y = new Date();
                    if (n.calendarType === "jalali") {
                        if (dayNumber < 1) {
                            jd = pMonthDays + dayNumber;
                            jm = pMonth;
                            jy = pYear
                        } else if (dayNumber > o) {
                            jd = dayNumber - o;
                        ...
                        var gDate = jalaali.toGregorian(jy, jm + 1, jd);
                        y = new Date(gDate.gy, gDate.gm - 1, gDate.gd)
                    } else {
                        y = new Date(t, e, g - a + 1);
                        var C = g < a || o + a <= g, E = g - a + 1;
                        if (C) {
                            if (g < a) {
                                E = pMonthDays + E;
                                jm = pMonth;
                    ...
                    var k = !!B._isDate(this.date) && B._compareDates(y, this.date), b = B._compareDates(y, s),
                        w = -1 !== n.events.indexOf(y.toDateString()), C = dayNumber < 1 || dayNumber > o,
            ...
            key: "renderTitle", value: function (t, e, i, n, s, o) {
                ...
                if (this.options.calendarType === "jalali") {
                    for (l = 0; l < 12; l++) {
                        d.push('<option value="' + l + '"' + (l === n ? ' selected="selected"' : "") + ">" + u.i18n.months[l] + "</option>")
                    }
                    a = '<select class="datepicker-select orig-select-month" tabindex="-1">' + d.join("") + "</select>";
                    for (l = i - u.yearRange, h = 1 + i + u.yearRange, d = []; l < h && l <= u.maxYear; l++) {
                ...
                v += '<button class="month-next' + (m ? "" : " is-disabled") + '" type="button"><svg fill="#000000" height="24" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg"><path d="M8.59 16.34l4.58-4.59-4.58-4.59L10 5.75l6 6-6 6z"/><path d="M0-.25h24v24H0z" fill="none"/></svg></button>';
                return v + "</div>"
            }
        }, {
            ...
            key: "_setupVariables", value: function () {
                ...
                this.formats = {
                    d: function () {
                        if (e.options.calendarType === "jalali") {
                            var jd = jalaali.toJalaali(e.date.getFullYear(), e.date.getMonth() + 1, e.date.getDate());
                            return jd.jd
                        } else {
                        ...
                        if (e.options.calendarType === "jalali") {
                            var jd = jalaali.toJalaali(e.date.getFullYear(), e.date.getMonth() + 1, e.date.getDate());
                            return e.options.i18n.monthsShort[jd.jm - 1]
                        } else {
                        ...
                        if (e.options.calendarType === "jalali") {
                            var jd = jalaali.toJalaali(e.date.getFullYear(), e.date.getMonth() + 1, e.date.getDate());
                            return e.options.i18n.months[jd.jm - 1]
                        } else {
            ...
            key: "_handleCalendarClick", value: function (t) {
                if (this.isOpen) {
                    var e = g(t.target);
                    if (!e.hasClass("is-disabled")) {
                        if (!e.hasClass("datepicker-day-button") || e.hasClass("is-empty") || e.parent().hasClass("is-disabled")) {
                            if (e.closest(".month-prev").length) {
                                this.prevMonth()
                            } else if (e.closest(".month-next").length) {
                                this.nextMonth()
                            }
                        } else {
                            if (this.options.calendarType === "jalali") {
                                this.setDate(this._createDateFromJalaali(parseInt(t.target.getAttribute("data-year")), parseInt(t.target.getAttribute("data-month")), parseInt(t.target.getAttribute("data-day"))))
                            } else {
                                this.setDate(new Date(t.target.getAttribute("data-year"), t.target.getAttribute("data-month"), t.target.getAttribute("data-day")))
                            }
            ...
            key: "_handleInputChange", value: function (t) {
                ...
                if (t.firedBy !== this) {
                    if (this.options.parse) {
                        e = this.options.parse(this.el.value, this.options.format)
                    } else {
                        if (this.options.calendarType === "jalali") {
                            e = this._parseDate(this.el.value)
                        } else {
                            e = new Date(Date.parse(this.el.value))
                        }
                    }
            ...
            key: "_parseDate", value: function (value) {
                var parts = value.split(' ');
                if (parts.length === 3) {
                    var monthIndex = this.options.i18n.monthsShort.indexOf(parts[0]);
                    if (monthIndex !== -1) {
                        var day = parseInt(parts[1].replace(',', ''));
                        var year = parseInt(parts[2]);
                        var gDate = jalaali.toGregorian(year, monthIndex + 1, day);
            ...
            key: "_createDateFromJalaali", value: function (jy, jm, jd) {
                var gDate = jalaali.toGregorian(jy, jm + 1, jd);
                return new Date(gDate.gy, gDate.gm - 1, gDate.gd)
            }
        }], [{
            ...
            key: "_getDaysInMonth", value: function (t, e, ctp) {
                if (ctp === "jalali") {
                    if (e < 6) return 31;
                    if (e < 11) return 30;
                    return jalaali.isLeapJalaaliYear(t) ? 30 : 29
                } else {
                    return [31, B._isLeapYear(t) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e]
                }
            }
        }, {
            key: "_isLeapJalaaliYear", value: function (jy) {
